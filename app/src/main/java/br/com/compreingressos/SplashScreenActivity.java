...
public class SplashScreenActivity extends Activity {
    ...
    private void checkForceUpdate(){
        Dialogs.showDialogForceUpdate(SplashScreenActivity.this, SplashScreenActivity.this, getString(R.string.force_update_dialog_text), getString(R.string.force_update_dialog_title), getApplicationContext().getPackageName());
    }
